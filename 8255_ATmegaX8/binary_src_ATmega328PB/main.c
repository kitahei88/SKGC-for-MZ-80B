...
/* ATmega328PB fuses: Low, High, Extended. */
...
// ext	7~4		not use (set 1)
//      CFD     0       Disable Clock Failure Detection 
...
static inline void init(void)
{
	...
	// PE0~3 not use. set input(pull up)
	PORTE	=	0b00001111;
	DDRE	=	0b00000000;	
	...
	ACSR	= 0x00; 
	PRR0		= 0x00;	// full power 
	PRR1		= 0x00;	// full power 	
